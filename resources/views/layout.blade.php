                    ...
                    <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($navHeader['genres'] as $key=>$item)
                        ...
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($navHeader['countries']  as $key=>$item)
                                    <li><a title="{{$item->title}}"
                        ...
                        <li class="mega dropdown">
                            ...
                            <ul role="menu" class=" dropdown-menu">
                                @foreach($navHeader['year_movie'] as $year)
                                    <li class="">
                        ...
                        @foreach($navHeader['categories'] as $key=>$item)
                            <li class="mega">
