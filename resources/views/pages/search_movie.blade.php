    ...
    <div class="row container" id="wrapper">
        <div class="halim-panel-filter">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-6">
                        <div class="yoast_breadcrumb hidden-xs"><span><span><a href="">Phim tìm kiếm theo</a> »
                            <span class="breadcrumb_last" aria-current="page">{{$search}}</span></span></span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main id="main-contents" class="col-xs-12 col-sm-12 col-md-8">
            <section>
                <div class="section-bar clearfix">
                    <h1 class="section-title"><span>Phim: {{$search}}</span></h1>
                </div>
                <div class="halim_box">
