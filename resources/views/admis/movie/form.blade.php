            ...
            <div class="col-md-8">
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        {!! form::select('country_id',$countries,isset($movie)?$movie->country_id:null,['class'=>'form-control']) !!}
                    </div>
                    <div class="form-group">
                        {!! form::label('category','Danh mục phim',[]) !!}
                        {!! form::select('category_id',$categories,isset($movie)?$movie->category_id:null,['class'=>'form-control']) !!}
                    </div>
                    <div class="form-group">
